...
namespace Sphereon.SDK.Classification.Api
{
    ...
    public interface IProjectApi : IApiAccessor
    {
        ...
        ApiResponse<byte[]> GetProjectStreamByLocationWithHttpInfo (string projectId, StreamLocation streamLocation);
        /// <summary>
        ...
        System.Threading.Tasks.Task<byte[]> GetProjectStreamByLocationAsync (string projectId, StreamLocation streamLocation);
        ...
        System.Threading.Tasks.Task<ApiResponse<byte[]>> GetProjectStreamByLocationAsyncWithHttpInfo (string projectId, StreamLocation streamLocation);
        /// <summary>
        /// Get project stream by locationid
        /// </summary>
        /// <remarks>
    ...
    public partial class ProjectApi : IProjectApi
    {
        ...
        public ApiResponse< ProjectResponse > CreateProjectWithHttpInfo (ProjectSettings projectsettings)
        {
            ...
            if (projectsettings == null)
                throw new ApiException(400, "Missing required parameter 'projectsettings' when calling ProjectApi->CreateProject");

            var localVarPath = "/classification/0.1/projects";
        ...
        public ApiResponse< ProjectResponse > DeleteProjectWithHttpInfo (string projectId)
        {
            ...
            var localVarPath = "/classification/0.1/projects/{projectId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< ProjectResponse > DeleteProjectStreamWithHttpInfo (string projectId, string projectStreamLocationId)
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new ApiException(400, "Missing required parameter 'projectId' when calling ProjectApi->DeleteProjectStream");
            // verify the required parameter 'projectStreamLocationId' is set
            if (projectStreamLocationId == null)
                throw new ApiException(400, "Missing required parameter 'projectStreamLocationId' when calling ProjectApi->DeleteProjectStream");

            var localVarPath = "/classification/0.1/projects/{projectId}/streams/{projectStreamLocationId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <summary>
        /// Get project stream by location Download the project data.
        /// </summary>
        /// <exception cref="Sphereon.SDK.Classification.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="projectId">projectId</param>
        /// <param name="streamLocation">streamLocation</param>
        /// <returns>byte[]</returns>
        public byte[] GetProjectStreamByLocation (string projectId, StreamLocation streamLocation)
        {
             ApiResponse<byte[]> localVarResponse = GetProjectStreamByLocationWithHttpInfo(projectId, streamLocation);
             return localVarResponse.Data;
        }
        ...
        /// <param name="streamLocation">streamLocation</param>
        /// <returns>ApiResponse of byte[]</returns>
        public ApiResponse< byte[] > GetProjectStreamByLocationWithHttpInfo (string projectId, StreamLocation streamLocation)
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new ApiException(400, "Missing required parameter 'projectId' when calling ProjectApi->GetProjectStreamByLocation");
            // verify the required parameter 'streamLocation' is set
            if (streamLocation == null)
                throw new ApiException(400, "Missing required parameter 'streamLocation' when calling ProjectApi->GetProjectStreamByLocation");

            var localVarPath = "/classification/0.1/projects/{projectId}/streams";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            localVarPathParams.Add("format", "json");
            if (projectId != null) localVarPathParams.Add("projectId", Configuration.ApiClient.ParameterToString(projectId)); // path parameter
            if (streamLocation != null && streamLocation.GetType() != typeof(byte[]))
            {
                localVarPostBody = Configuration.ApiClient.Serialize(streamLocation); // http body (model) parameter
            }
            else
            {
                localVarPostBody = streamLocation; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetProjectStreamByLocation", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="streamLocation">streamLocation</param>
        /// <returns>Task of byte[]</returns>
        public async System.Threading.Tasks.Task<byte[]> GetProjectStreamByLocationAsync (string projectId, StreamLocation streamLocation)
        {
             ApiResponse<byte[]> localVarResponse = await GetProjectStreamByLocationAsyncWithHttpInfo(projectId, streamLocation);
             return localVarResponse.Data;
        ...
        /// <param name="streamLocation">streamLocation</param>
        /// <returns>Task of ApiResponse (byte[])</returns>
        public async System.Threading.Tasks.Task<ApiResponse<byte[]>> GetProjectStreamByLocationAsyncWithHttpInfo (string projectId, StreamLocation streamLocation)
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new ApiException(400, "Missing required parameter 'projectId' when calling ProjectApi->GetProjectStreamByLocation");
        ...
        public ApiResponse< byte[] > GetProjectStreamByLocationIdWithHttpInfo (string projectId, string projectStreamLocationId)
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new ApiException(400, "Missing required parameter 'projectId' when calling ProjectApi->GetProjectStreamByLocationId");
            // verify the required parameter 'projectStreamLocationId' is set
            if (projectStreamLocationId == null)
                throw new ApiException(400, "Missing required parameter 'projectStreamLocationId' when calling ProjectApi->GetProjectStreamByLocationId");
        ...
        public ApiResponse< StreamResponse > UpdateProjectStreamWithHttpInfo (string projectId, string projectStreamLocationId, System.IO.Stream stream)
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new ApiException(400, "Missing required parameter 'projectId' when calling ProjectApi->UpdateProjectStream");
            // verify the required parameter 'projectStreamLocationId' is set
            if (projectStreamLocationId == null)
                throw new ApiException(400, "Missing required parameter 'projectStreamLocationId' when calling ProjectApi->UpdateProjectStream");
            // verify the required parameter 'stream' is set
            if (stream == null)
                throw new ApiException(400, "Missing required parameter 'stream' when calling ProjectApi->UpdateProjectStream");
        ...
        public ApiResponse< StreamResponse > UploadProjectStreamWithHttpInfo (string projectId, System.IO.Stream stream)
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new ApiException(400, "Missing required parameter 'projectId' when calling ProjectApi->UploadProjectStream");
            // verify the required parameter 'stream' is set
            if (stream == null)
                throw new ApiException(400, "Missing required parameter 'stream' when calling ProjectApi->UploadProjectStream");
