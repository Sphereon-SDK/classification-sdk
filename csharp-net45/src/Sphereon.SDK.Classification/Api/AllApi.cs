...
namespace Sphereon.SDK.Classification.Api
{
    ...
    public interface IAllApi : IApiAccessor
    {
        ...
        /// <param name="jobId">jobId</param>
        /// <returns>ApiResponse of ClassificationJobResponse</returns>
        ApiResponse<ClassificationJobResponse> GetJobWithHttpInfo (string jobId);
        /// <summary>
        /// Get all jobs
        /// </summary>
        /// <remarks>
        ...
        /// <param name="jobId">jobId</param>
        /// <returns>Task of ClassificationJobResponse</returns>
        System.Threading.Tasks.Task<ClassificationJobResponse> GetJobAsync (string jobId);
        ...
        /// <param name="jobId">jobId</param>
        /// <returns>Task of ApiResponse (ClassificationJobResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ClassificationJobResponse>> GetJobAsyncWithHttpInfo (string jobId);
        /// <summary>
        /// Get all jobs
        /// </summary>
        /// <remarks>
    ...
    public partial class AllApi : IAllApi
    {
        ...
        public ApiResponse< ClassificationJobResponse > AddProjectIdWithHttpInfo (string jobId, string projectId)
        {
            ...
            var localVarPath = "/classification/0.1/jobs/{jobId}/projects/{projectId}";
        ...
        public ApiResponse< ClassificationJobResponse > CreateClassificationJobWithHttpInfo (ClassificationSettings classificationSettings)
        {
            ...
            var localVarPath = "/classification/0.1/jobs";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< ClassificationJobResponse > DeleteJobWithHttpInfo (string jobId)
        {
            ...
            var localVarPath = "/classification/0.1/jobs/{jobId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        public ApiResponse< ClassificationResponse > GetClassificationResultWithHttpInfo (string jobId)
        {
            ...
            var localVarPath = "/classification/0.1/jobs/{jobId}/result";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="jobId">jobId</param>
        /// <returns>ClassificationJobResponse</returns>
        public ClassificationJobResponse GetJob (string jobId)
        {
             ApiResponse<ClassificationJobResponse> localVarResponse = GetJobWithHttpInfo(jobId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="jobId">jobId</param>
        /// <returns>ApiResponse of ClassificationJobResponse</returns>
        public ApiResponse< ClassificationJobResponse > GetJobWithHttpInfo (string jobId)
        {
            // verify the required parameter 'jobId' is set
            if (jobId == null)
        ...
        /// <param name="jobId">jobId</param>
        /// <returns>Task of ClassificationJobResponse</returns>
        public async System.Threading.Tasks.Task<ClassificationJobResponse> GetJobAsync (string jobId)
        {
             ApiResponse<ClassificationJobResponse> localVarResponse = await GetJobAsyncWithHttpInfo(jobId);
             return localVarResponse.Data;
        ...
        /// <param name="jobId">jobId</param>
        /// <returns>Task of ApiResponse (ClassificationJobResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ClassificationJobResponse>> GetJobAsyncWithHttpInfo (string jobId)
        {
            // verify the required parameter 'jobId' is set
            if (jobId == null)
                throw new ApiException(400, "Missing required parameter 'jobId' when calling AllApi->GetJob");
        ...
        public ApiResponse< byte[] > GetProjectStreamByLocationWithHttpInfo (string projectId, StreamLocation streamLocation)
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new ApiException(400, "Missing required parameter 'projectId' when calling AllApi->GetProjectStreamByLocation");
            // verify the required parameter 'streamLocation' is set
            if (streamLocation == null)
                throw new ApiException(400, "Missing required parameter 'streamLocation' when calling AllApi->GetProjectStreamByLocation");
        ...
        public ApiResponse< StreamResponse > UploadInputFileWithHttpInfo (string jobId, System.IO.Stream stream)
        {
            ...
            var localVarPath = "/classification/0.1/jobs/{jobId}/streams";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
