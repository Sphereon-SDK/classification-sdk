...
namespace Sphereon.SDK.Classification.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectClassificationTextLine :  IEquatable<ProjectClassificationTextLine>, IValidatableObject
    {
        /// <summary>
        ...
        public ProjectClassificationTextLine(int? Top = default(int?), int? Left = default(int?), int? Bottom = default(int?), int? Width = default(int?), List<ProjectClassificationWord> Words = default(List<ProjectClassificationWord>), int? Right = default(int?), string Text = default(string), int? Height = default(int?))
        {
            this.Top = Top;
            this.Left = Left;
            this.Bottom = Bottom;
