...
namespace Sphereon.SDK.Classification.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClassificationResponse :  IEquatable<ClassificationResponse>, IValidatableObject
    {
        ...
        public ClassificationResponse(ClassificationResult ClassificationResult = default(ClassificationResult), ClassificationSummary Summary = default(ClassificationSummary), List<DetailLevelsEnum> DetailLevels = default(List<DetailLevelsEnum>), JobInfo JobInfo = default(JobInfo))
        {
