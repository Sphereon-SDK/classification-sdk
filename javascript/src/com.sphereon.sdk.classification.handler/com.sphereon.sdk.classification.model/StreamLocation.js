...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.classification.StreamLocation = factory(root.classification.ApiClient);
  }
   ...
   * @module com.sphereon.sdk.classification.handler/com.sphereon.sdk.classification.model/StreamLocation
   * @version 0.3.2
   */
   ...
   * @alias module:com.sphereon.sdk.classification.handler/com.sphereon.sdk.classification.model/StreamLocation
   * @class
   */
   ...
   * @param {module:com.sphereon.sdk.classification.handler/com.sphereon.sdk.classification.model/StreamLocation} obj Optional instance to populate.
   * @return {module:com.sphereon.sdk.classification.handler/com.sphereon.sdk.classification.model/StreamLocation} The populated <code>StreamLocation</code> instance.
   */
