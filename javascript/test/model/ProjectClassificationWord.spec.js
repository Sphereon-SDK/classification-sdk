...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new classification.ProjectClassificationWord();
  });
  ...
  describe('ProjectClassificationWord', function() {
    it('should create an instance of ProjectClassificationWord', function() {
      // uncomment below and update the code to test ProjectClassificationWord
      //var instane = new classification.ProjectClassificationWord();
      //expect(instance).to.be.a(classification.ProjectClassificationWord);
    });
