...
namespace Sphereon.SDK.Classification.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Inline :  IEquatable<Inline>
    {
        /// <summary>
        ...
        public Inline(List<ProjectClassificationPage> Pages = null, List<ProjectClassificationDocument> Documents = null)
        {
            this.Pages = Pages;
